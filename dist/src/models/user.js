...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Unable to show user " + id + ": " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, checksql, checkResult, checkUser, sql, hash, result, user, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                    ...
                    case 1:
                        conn = _a.sent();
                        checksql = 'SELECT username FROM users WHERE username=($1)';
                        return [4 /*yield*/, conn.query(checksql, [u.username])];
                    case 2:
                        checkResult = _a.sent();
                        checkUser = checkResult.rows[0];
                        if (!!checkUser) return [3 /*break*/, 4];
                    ...
                    case 6:
                        err_3 = _a.sent();
                        throw new Error("Unable to create user (" + u.username + "): " + err_3);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT password_digest, id FROM users WHERE username=($1)';
    ...
    UserStore.prototype.update = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, hash, result, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        sql = 'UPDATE users SET password_digest = ($1) WHERE username = ($2) RETURNING id, password_digest';
                        hash = bcrypt_1.default.hashSync(password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, conn.query(sql, [hash, username])];
                    case 2:
                        result = _a.sent();
                        user = result.rows[0];
                        conn.release();
