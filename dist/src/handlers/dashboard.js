...
var productsInOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, token, products, err_1;
...
var usersWithOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, token, users, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
var fiveMostExpensive = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var currentOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, authHeader, token, cart, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
            ...
            case 1:
                ...
                token = authHeader.split(' ')[1];
                jsonwebtoken_1.default.verify(token, process.env.TOKEN_SECRET);
                return [4 /*yield*/, dashboard.currentOrder(id)];
            case 2:
                cart = _a.sent();
                res.json(cart);
                return [3 /*break*/, 4];
