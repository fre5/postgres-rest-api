        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT name, price, order_id FROM products INNER JOIN order_products ON products.id = order_products.id';
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Unable to retrieve products and orders: " + err_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Unable to get users with orders: " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Unable to get products by price: " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    DashboardQueries.prototype.currentOrder = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT order_products.id, product_id, quantity, user_id , status FROM order_products LEFT JOIN orders ON order_products.order_id = orders.id WHERE user_id=($1)';
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Unable to retrieve orders by user id " + id + ": " + err_4);
                    case 4: return [2 /*return*/];
                }
            });
        });
