...
- Open `.env` file on the root of the directory. We will need to fill up the variables with the proper values
  POSTGRES_HOST=(host address, typically localhost or 127.0.0.1, or a remote IP address if the database is on a different computer)
