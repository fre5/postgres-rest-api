        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not retrieve orders: " + err_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find order id: " + id + ". Error: " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [o.userId, o.status])];
                    case 2:
                        result = _a.sent();
                        order = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not create order id: " + o.userId + ". Error: " + err_5);
                    case 4: return [2 /*return*/];
                }
            });
        });
